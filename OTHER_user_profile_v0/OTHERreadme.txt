...
ANTES de tudo, precisamos mudar o arquivo .json que vamos utilizar. SUBSTITUA a linha do .html que atualmente contém o código "<script src="OTHERapp0.js"></script>" PELA seguinte linha:
<script src="OTHERapp_backup.js"></script>
...
>> Como iniciar?
  - Navegue até o diretório onde está localizado o arquivo `OTHERdb0.json` que eu compartilhei com você. Esse arquivo contém dados de exemplo para o nosso website.
  - No terminal, estando dentro do diretório correto, execute: `json-server --watch OTHERdb0.json`
